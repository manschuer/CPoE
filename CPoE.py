...
#from bandmat.linalg import band_of_inverse_from_chol # solveh, cholesky, cho_solve, 
...
#from invTakC import  w_invTakC5, w_invTakC6c, w_invTakC11 ##it has to be compiled!!
#from invTakC import   w_invTakC11 ##it has to be compiled!!
...
class BlockGP:
	...
	def plot_predecessors(self, SUCCESSORS=True, Ak=False, Ck=False, Pos=(None, None)):
